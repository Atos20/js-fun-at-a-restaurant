...
inStock = inStock + inStock; //=> inStock = 1 + 1 =>2
//inStock = 2
...
var shouldOrderMore = (inStock < 20) ? true : false; // => true
...
var vegetables = ['cucumber', 'potatoe', 'onion', 'garlic'];

// Write the code to access the 3rd element of the Array, using bracket
// notation.
var thirdItem = vegetables[2];
// Create a new variable "fruits" and assign it to an Array of 7
// different fruits.
var fruits = ['strawberry', 'raspberry', 'blueberry', 'banana', 'mango', 'orange', 'cherries'];

// Write the code to access the 5th element of the array, using bracket notation.
var fifthItem = fruits[4];
